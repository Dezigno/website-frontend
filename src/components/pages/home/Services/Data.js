export const homeObjOne = {
    ...
    lightText: false,
    lightTextDesc: false,
    topLine: 'کنترل و مدیریت کامل',
    headline: ' با استفاده از سرویس چاپ بر حسب نیاز، بدون دغدغه بر تمام فرآیند مدیریت کنید',
    description:
  ...
  export const homeObjThree = {
    ...
    lightTextDesc: false,
    topLine: 'طراحی آسان',
    headline: 'تعریف آسان طرح با ابزار های آنلاین',
    description:
